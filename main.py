...
Database Convention:
⚠️  All skill names in Neo4j are stored in LOWERCASE for consistent matching.
    This ensures "Python" and "python" are treated identically without 
    performance overhead from toLower() conversions in queries.
"""
